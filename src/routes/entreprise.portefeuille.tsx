        ...
        <Card>
          ...
          <CardContent className="space-y-2 max-h-80 overflow-y-auto">
            {(w?.transactions ?? []).map((t) => (
              <div
                key={t.id}
                className="flex flex-wrap items-center justify-between gap-2 text-sm border-b border-border py-2"
              >
      ...
      <Card className="mt-6">
        ...
        <CardContent className="space-y-2">
          {(w?.retraits ?? []).map((r) => (
            <div
              key={r.id}
              className="flex flex-wrap items-center justify-between gap-2 text-sm py-2 border-b"
            >
              <span>
