              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-2xl font-bold text-destructive">
                    {company.resume_livraisons.en_retard}
                  </p>
                </CardContent>
              </Card>
              <Card>
            ...
            <Card className="mt-4">
              <CardHeader>
                <CardTitle className="text-sm font-semibold">
                  Livreurs ({company.livreurs.length})
                </CardTitle>
              </CardHeader>
                  ...
                  <div key={liv.id} className="rounded-lg border border-border p-3">
                    <div className="mb-2 flex flex-wrap items-center gap-2">
                      <Badge variant="outline">
                        {liv.type_livraison === "externe" ? "Externe" : "Commande"}
                      </Badge>
                      <Badge variant={liv.en_retard ? "destructive" : "secondary"}>
                        {formatStatutLabel(liv.statut)}
                      </Badge>
